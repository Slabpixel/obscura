  ...
  return (
    <section id="features" className="h-dvh min-h-180 max-h-300 relative text-background overflow-hidden pb-16 pt-50 scroll-mt-28">
      ...
      <div className="relative mx-auto h-full max-w-8xl lg:px-10 md:px-8 sm:px-6 px-4">
        <div className="relative h-full w-full flex flex-col items-center justify-start gap-17.5">
        ...
        {/* <Image src="/person.png" alt="Person" width={299} height={348} className="absolute z-1 bottom-0 left-1/2 -translate-x-1/2" /> */}
      </div>
    </section>
  );
}
