...
export default function Resources() {
    return (
        <section id="pricing" className="relative py-30">
            <div className="mx-auto max-w-8xl px-4 sm:px-6 md:px-8 lg:px-10">
                <div className="flex flex-col items-center gap-16 w-full mx-auto max-w-292.5">
                    ...
                    <div className="w-full">
                        <Image src="/full.png" alt="" width={2000} height={2000} />
                    </div>

                    <p className="text-center font-mono font-medium tracking-wider uppercase">
